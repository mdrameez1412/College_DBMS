...
if(isset($_POST['studentid']) && isset($_POST['thirdterm']) ){
...
if ( isset($studentid) && isset($thirdterm) ) {
$sql = "UPDATE fees SET THIRD_TERM='$thirdterm' WHERE STUDENT_ID=$studentid";
}
...
<!DOCTYPE html>
<head>
  <title>UPDATING THIRD TERM FEES DETAIL IN FEES TABLE</title>
</head>
<body>
  ...
  <h3 style="font-size:150%;font-family:algerian;"><i>UPDATING THIRD TERM FEES DETAIL IN FEES TABLE</i></h3><br></th></tr>
</table>
  <table style="width:100%;">
  <tr style="border:5px solid white;background:#1aff1a"><th style="border:5px solid black;font-size:large;width: 50%;"><a href="updatefees.html">
...
if (mysqli_query($conn, $sql)) {
  echo ('<h2 style="color: green;">'."THIRD TERM FEES DETAIL FOR STUDENT_ID $studentid HAS BEEN CHANGED TO $thirdterm"."</h2>\n");
} else {
 ...
 ?>
  ...
  <tr><th>
   <form method="POST" style="background:lightyellow;" >
    <label for="studentid">STUDENT_ID WHOSE FEES DETAIL NEED TO BE CHANGED:</label><br><br>
