...
if(isset($_POST['bloodgroup']) && isset($_POST['studentid']) ){
...
if ( isset($bloodgroup) && isset($studentid) ) {
$sql = "UPDATE student SET BLOOD_GROUP='$bloodgroup' WHERE STUDENT_ID=$studentid";
}
...
<!DOCTYPE html>
<head>
  <title>UPDATING STUDENT BLOOD_GROUP IN STUDENT TABLE</title>
</head>
<body>
  ...
  <h3 style="font-size:150%;font-family:algerian;"><i>UPDATING STUDENT BLOOD_GROUP IN STUDENT TABLE</i></h3><br></th></tr>
</table>
  ...
  <div align="center">
<?php
if ( isset($studentid) && isset($bloodgroup) ) {

if (mysqli_query($conn, $sql)) {
  echo ('<h2 style="color: green;">'."STUDENT BLOOD_GROUP UPDATED AS $bloodgroup FOR STUDENT_ID $studentid"."</h2>\n");
} else {
 ...
 ?>
  ...
  <tr><th>
   <form method="POST" style="background:lightyellow;" >
    <label for="studentid"> STUDENT_ID WHOSE BLOOD_GROUP NEED TO BE CHANGED:</label><br><br>
    <input type="text" id="studentid" name="studentid"><br><br>
    <label for="bloodgroup">NEW BLOOD_GROUP:</label><br><br>
