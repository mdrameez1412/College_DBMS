...
$sql = "SELECT * FROM  second_term_fee";
...
<title> FEES PENDING RECORD</title>
</head>
<body>
...
<h3 style="font-size:150%;font-family:algerian;"><i>FEES PENDING RECORD</i></h3>
</th></tr>
</table >
...
<tr style="border:3px solid black;">
  ...
  <td style="border:3px solid black;font-size:large;"><div align="center"><?php echo $row["STUDENT_F_NAME"]. " " . $row["STUDENT_L_NAME"];?></td></div></tr>
