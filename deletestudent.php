...
<!DOCTYPE html>
<head>
  <title>DELETING A STUDENT DATA</title>
</head>
<body>
  ...
  <h3 style="font-size:150%;font-family:algerian;"><i>DELETING A STUDENT DATA</i></h3><br></th></tr>
</table>
...
if (mysqli_query($conn, $sql)) {
  ...
  echo ('<h2 style="color: green;">'. " STUDENT RECORD DELETED SUCCESFULLY"."</h2>\n");
} else {
