...
$sql = "SELECT * FROM class join teacher where `class`.`CLASS_ADVISOR_ID`=`teacher`.`TEACHER_ID`";
...
<h3 style="font-size:150%;font-family:algerian;"><i>CLASS RECORD</i></h3>
</th></tr>
</table >
...
<table style="border:5px solid black;background:lightyellow; width="100%"">
  <th style="border:3px solid black;font-size:large;color:red;">CLASS ID</th>
  <th style="border:3px solid black;font-size:large;color:red;">CLASS AND SECTION</th>
  <th style="border:3px solid black;font-size:large;color:red;">CLASS STRENGTH</th>

  <th style="border:3px solid black;font-size:large;color:red;">CLASS ADVISOR ID</th>
  <th style="border:3px solid black;font-size:large;color:red;">CLASS ADVISOR NAME</th>
 <th style="border:3px solid black;font-size:large;color:red;">CLASS ADVISOR MOBILE</th>
...
<tr style="border:3px solid black;">
  ...
  <td style="border:3px solid black;font-size:large;"><div align="center"><?php echo $row["CLASS_AND_SECTION"];?></td></div>
  <td style="border:3px solid black;font-size:large;"><div align="center"><?php echo $row["CLASS_STRENGTH"]; ?></td></div>
