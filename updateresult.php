...
if(isset($_POST['courseid']) && isset($_POST['studentid']) && isset($_POST['mark']) ){
...
if ( isset($courseid) && isset($studentid) && isset($mark) ) {
$sql = "UPDATE result SET MARKS='$mark' WHERE STUDENT_ID=$studentid AND COURSE_ID=$courseid";
}
...
<!DOCTYPE html>
<head>
  <title>UPDATING STUDENT MARKS IN RESULT TABLE</title>
</head>
<body>
  ...
  <h3 style="font-size:150%;font-family:algerian;"><i>UPDATING STUDENT MARKS IN RESULT TABLE</i></h3><br></th></tr>
</table>
  <table style="width:100%;">
  <tr style="border:5px solid white;background:#1aff1a"><th style="border:5px solid black;font-size:large;width: 50%;"><a href="update.html">
  ...
  <div align="center">
<?php
if ( isset($studentid) && isset($courseid) && isset($mark) ) {

if (mysqli_query($conn, $sql)) {
  echo ('<h2 style="color: green;">'."MARKS UPDATED AS $mark FOR STUDENT_ID $studentid WITH COURSE_ID AS $courseid"."</h2>\n");
} else {
 ...
 ?>
  ...
  <tr><th>
   <form method="POST" style="background:lightyellow;" >
    <label for="studentid"> STUDENT_ID WHOSE MARK DETAIL NEED TO BE CHANGED:</label><br><br>
    <input type="text" id="studentid" name="studentid"><br><br>
    <label for="courseid"> COURSE_ID FOR WHICH MARK DETAIL NEED TO BE CHANGED:</label><br><br>
    <input type="text" id="courseid" name="courseid"><br><br>
    <label for="mark">NEW MARKS:</label><br><br>
    <input type="number" id="mark" name="mark" max="100"><br><br>
