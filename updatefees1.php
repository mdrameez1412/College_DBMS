...
if(isset($_POST['studentid']) && isset($_POST['firstterm']) ){
...
if ( isset($studentid) && isset($firstterm) ) {
$sql = "UPDATE fees SET FIRST_TERM='$firstterm' WHERE STUDENT_ID=$studentid";
}
...
<!DOCTYPE html>
<head>
  <title>UPDATING FIRST TERM FEES DETAIL IN FEES TABLE</title>
</head>
<body>
  ...
  <h3 style="font-size:150%;font-family:algerian;"><i>UPDATING FIRST TERM FEES DETAIL IN FEES TABLE</i></h3><br></th></tr>
</table>
...
if (mysqli_query($conn, $sql)) {
  echo ('<h2 style="color: green;">'."FIRST TERM FEES DETAIL FOR STUDENT_ID $studentid HAS BEEN CHANGED TO $firstterm"."</h2>\n");
} else {
