...
if(isset($_POST['examid']) && isset($_POST['startdate']) ){
$examid=$_POST['examid'];
...
if ( isset($examid) && isset($startdate) ) {
$sql = "UPDATE exam SET START_DATE='$startdate' WHERE EXAM_ID=$examid";
}
...
<!DOCTYPE html>
<head>
  <title>UPDATING START_DATE IN EXAM TABLE</title>
</head>
<body>
  ...
  <h3 style="font-size:150%;font-family:algerian;"><i>UPDATING START_DATE IN EXAM TABLE</i></h3><br></th></tr>
</table>
...
if (mysqli_query($conn, $sql)) {
  echo ('<h2 style="color: green;">'."START_DATE UPDATED AS $startdate FOR EXAM_ID $examid"."</h2>\n");
} else {
 ...
 ?>
  ...
  <tr><th>
   <form method="POST" style="background:lightyellow;" >
    <label for="examid">EXAM_ID WHOSE START_DATE NEED TO BE CHANGED:</label><br><br>
