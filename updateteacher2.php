...
if(isset($_POST['teacherfname']) && isset($_POST['teacherid']) ){
...
if ( isset($teacherfname) && isset($teacherid) ) {
$sql = "UPDATE teacher SET TEACHER_F_NAME='$teacherfname' WHERE TEACHER_ID=$teacherid";
}
...
<!DOCTYPE html>
<head>
  <title>UPDATING TEACHER_FIRST_NAME IN TEACHER TABLE</title>
</head>
<body>
  ...
  <h3 style="font-size:150%;font-family:algerian;"><i>UPDATING TEACHER_FIRST_NAME IN TEACHER TABLE</i></h3><br></th></tr>
</table>
  ...
  <div align="center">
<?php
if ( isset($teacherid) && isset($teacherfname) ) {

if (mysqli_query($conn, $sql)) {
  echo ('<h2 style="color: green;">'."TEACHER_FIRST_NAME UPDATED AS $teacherfname FOR TEACHER_ID $teacherid"."</h2>\n");
} else {
 ...
 ?>
  ...
  <tr><th>
   <form method="POST" style="background:lightyellow;" >
    <label for="teacherid"> TEACHER_ID WHOSE FIRST NAME NEED TO BE CHANGED:</label><br><br>
    <input type="text" id="teacherid" name="teacherid"><br><br>
    <label for="teacherfname">NEW TEACHER_FIRST_NAME:</label><br><br>
