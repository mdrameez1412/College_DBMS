...
if(isset($_POST['studentid']) && isset($_POST['studentgender']) ){
...
if ( isset($studentid) && isset($studentgender) ) {
$sql = "UPDATE student SET STUDENT_GENDER='$studentgender' WHERE STUDENT_ID=$studentid";
}
...
<!DOCTYPE html>
<head>
  <title>UPDATING STUDENT_GENDER IN STUDENT TABLE</title>
</head>
<body>
  ...
  <h3 style="font-size:150%;font-family:algerian;"><i>UPDATING STUDENT_GENDER IN STUDENT TABLE</i></h3><br></th></tr>
</table>
...
if (mysqli_query($conn, $sql)) {
  echo ('<h2 style="color: green;">'."STUDENT_GENDER UPDATED AS $studentgender FOR STUDENT_ID $studentid"."</h2>\n");
} else {
 ...
 ?>
  ...
  <tr><th>
   <form method="POST" style="background:lightyellow;" >
    <label for="studentid">STUDENT_ID WHOSE GENDER NEED TO BE CHANGED:</label><br><br>
