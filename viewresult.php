...
$sql = "SELECT * FROM  result  WHERE  STUDENT_ID='$studentid' ";
...
<h3 style="font-size:150%;font-family:algerian;"><i>RESULT RECORD</i></h3>
</th></tr>
</table >
...
<table style="border:5px solid black;background:lightyellow;">
  ...
  <th style="border:3px solid black;font-size:large;color:red;">MARKS</th>
...
<tr style="border:3px solid black;">
  ...
  <td style="border:3px solid black;font-size:large;"><div align="center"><?php echo  $row["MARKS"];?></td></div>
