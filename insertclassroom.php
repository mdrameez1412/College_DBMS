...
$sql = "INSERT INTO classroom (STUDENT_ID,CLASS_ID)
...
<!DOCTYPE html>
<head>
  <title>INSERTING DATA INTO CLASSROOM TABLE</title>
</head>
<body>
  ...
  <h3 style="font-size:150%;font-family:algerian;"><i>INSERTING DATA INTO CLASSROOM TABLE</i></h3><br></th></tr>
</table>
...
if (mysqli_query($conn, $sql)) {
  echo ('<h2 style="color: green;">'."NEW RECORD INSERTED INTO CLASSROOM TABLE SUCCESSFULLY"."</h2>\n");
} else {
