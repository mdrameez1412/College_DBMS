...
if(isset($_POST['teacherid']) && isset($_POST['teachermobile']) ){
...
if ( isset($teacherid) && isset($teachermobile) ) {
$sql = "UPDATE teacher SET TEACHER_MOBILE ='$teachermobile' WHERE TEACHER_ID=$teacherid";
}
...
<!DOCTYPE html>
<head>
  <title>UPDATING TEACHER_MOBILE IN TEACHER TABLE</title>
</head>
<body>
  ...
  <h3 style="font-size:150%;font-family:algerian;"><i>UPDATING TEACHER_MOBILE IN TEACHER TABLE</i></h3><br></th></tr>
</table>
...
if (mysqli_query($conn, $sql)) {
  echo ('<h2 style="color: green;">'."TEACHER_MOBILE UPDATED AS $teachermobile FOR TEACHER_ID $teacherid"."</h2>\n");
} else {
 ...
 ?>
  ...
  <tr><th>
   <form method="POST" style="background:lightyellow;" >
    <label for="teacherid">TEACHER_ID WHOSE  MOBILE NUMBER TO BE CHANGED:</label><br><br>
    <input type="text" id="teacherid" name="teacherid"><br><br>
    <label for="teachermobile">NEW TEACHER_MOBILE:</label><br><br>
