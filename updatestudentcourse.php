...
if ( isset($courseid) && isset($studentid) ) {
$sql = "UPDATE studentcourse SET COURSE_ID='$courseid' WHERE STUDENT_ID=$studentid";
}
...
<!DOCTYPE html>
<head>
  <title>UPDATING COURSE_ID FOR A STUDENT IN STUDENT_COURSE TABLE</title>
</head>
<body>
  ...
  <h3 style="font-size:150%;font-family:algerian;"><i>UPDATING COURSE_ID FOR A STUDENT IN STUDENT_COURSE TABLE</i></h3><br></th></tr>
</table>
...
if (mysqli_query($conn, $sql)) {
  echo ('<h2 style="color: green;">'."COURSE_ID UPDATED AS $courseid FOR STUDENT_ID $studentid"."</h2>\n");
} else {
 ...
 ?>
  ...
  <tr><th>
   <form method="POST" style="background:lightyellow;" >
    <label for="studentid"> STUDENT_ID WHOSE COURSE_ID NEED TO BE CHANGED:</label><br><br>
