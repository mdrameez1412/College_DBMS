...
if(isset($_POST['parentid']) && isset($_POST['oldparentid']) ){
...
if ( isset($parentid) && isset($oldparentid) ) {
$sql = "UPDATE parent SET PARENT_ID='$parentid' WHERE PARENT_ID=$oldparentid";
}
...
<!DOCTYPE html>
<head>
  <title>UPDATING PARENT_ID IN PARENT TABLE</title>
</head>
<body>
  ...
  <h3 style="font-size:150%;font-family:algerian;"><i>UPDATING PARENT_ID IN PARENT TABLE</i></h3><br></th></tr>
</table>
...
if (mysqli_query($conn, $sql)) {
  echo ('<h2 style="color: green;">'."PARENT_ID UPDATED FROM $oldparentid TO $parentid"."</h2>\n");
} else {
 ...
 ?>
  ...
  <tr><th>
   <form method="POST" style="background:lightyellow;" >
    <label for="oldparentid">OLD PARENT_ID THAT NEED TO BE CHANGED:</label><br><br>
    <input type="text" id="oldparentid" name="oldparentid"><br><br>
