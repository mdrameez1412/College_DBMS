...
if(isset($_POST['studentid']) && isset($_POST['secondterm']) ){
...
if ( isset($studentid) && isset($secondterm) ) {
$sql = "UPDATE fees SET SECOND_TERM='$secondterm' WHERE STUDENT_ID=$studentid";
}
...
<!DOCTYPE html>
<head>
  <title>UPDATING SECOND TERM FEES DETAIL IN FEES TABLE</title>
</head>
<body>
  ...
  <h3 style="font-size:150%;font-family:algerian;"><i>UPDATING SECOND TERM FEES DETAIL IN FEES TABLE</i></h3><br></th></tr>
</table>
...
if (mysqli_query($conn, $sql)) {
  echo ('<h2 style="color: green;">'."SECOND TERM FEES DETAIL FOR STUDENT_ID $studentid HAS BEEN CHANGED TO $secondterm"."</h2>\n");
} else {
