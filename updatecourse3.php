...
if ( isset($courseid) && isset($teacherid) ) {
$sql = "UPDATE course SET TEACHER_ID='$teacherid' WHERE COURSE_ID=$courseid";
}
...
<!DOCTYPE html>
<head>
  <title>UPDATING TEACHER_ID IN COURSE TABLE</title>
</head>
<body>
  ...
  <h3 style="font-size:150%;font-family:algerian;"><i>UPDATING TEACHER_ID IN COURSE TABLE</i></h3><br></th></tr>
</table>
...
if (mysqli_query($conn, $sql)) {
  echo ('<h2 style="color: green;">'."TEACHER_ID UPDATED AS $teacherid FOR COURSE_ID $courseid"."</h2>\n");
} else {
 ...
 ?>
  ...
  <tr><th>
   <form method="POST" style="background:lightyellow;" >
    <label for="courseid">COURSE_ID WHOSE TEACHER_ID NEED TO BE CHANGED:</label><br><br>
