...
if(isset($_POST['classid']) && isset($_POST['class']) && isset($_POST['classstrength']) && isset($_POST['classadvisor']) ) {
...
if ( isset($classid) && isset($class) && isset($classstrength) && isset($classadvisor)  ) {
$sql = "INSERT INTO class (CLASS_ID,CLASS_AND_SECTION, CLASS_STRENGTH, CLASS_ADVISOR_ID)
VALUES ('$classid','$class','$classstrength','$classadvisor')";
}
...
<!DOCTYPE html>
<head>
  <title>INSERTING DATA INTO CLASS TABLE</title>
</head>
<body>
  ...
  <h3 style="font-size:150%;font-family:algerian;"><i>INSERTING DATA INTO CLASS TABLE</i></h3><br></th></tr>
</table>
...
if (mysqli_query($conn, $sql)) {
  echo ('<h2 style="color: green;">'."NEW RECORD INSERTED INTO CLASS TABLE SUCCESSFULLY"."</h2>\n");
} else {
 ...
 ?>
  ...
  <tr><th>
   <form method="POST" style="background:lightyellow;" >
    ...
    <label for="classstrength">CLASS_STRENGTH:</label><br><br>
    <input type="number" id="classstrength" name="classstrength"><br><br>
    <label for="classadvisor">CLASS_ADVISOR_ID:</label><br><br>
    <input type="text" id="classadvisor" name="classadvisor"><br><br>
