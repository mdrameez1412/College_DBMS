...
<!DOCTYPE html>
<head>
  <title>DELETING A EXAM DATA</title>
</head>
<body>
  ...
  <h3 style="font-size:150%;font-family:algerian;"><i>DELETING A EXAM DATA</i></h3><br></th></tr>
</table>
...
if (mysqli_query($conn, $sql)) {
  ...
  echo ('<h2 style="color: green;">'. " EXAM RECORD DELETED SUCCESFULLY"."</h2>\n");
} else {
