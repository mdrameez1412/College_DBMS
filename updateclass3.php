...
if(isset($_POST['classid']) && isset($_POST['classstrength']) ){
...
if ( isset($classid) && isset($classstrength) ) {
$sql = "UPDATE class SET CLASS_STRENGTH='$classstrength' WHERE CLASS_ID=$classid";
}
...
<!DOCTYPE html>
<head>
  <title>UPDATING CLASS_STRENGTH IN CLASS TABLE</title>
</head>
<body>
  ...
  <h3 style="font-size:150%;font-family:algerian;"><i>UPDATING CLASS_STRENGTH IN CLASS TABLE</i></h3><br></th></tr>
</table>
...
if (mysqli_query($conn, $sql)) {
  echo ('<h2 style="color: green;">'."CLASS_STRENGTH UPDATED AS $classstrength FOR CLASS_ID $classid"."</h2>\n");
} else {
 ...
 ?>
  ...
  <tr><th>
   <form method="POST" style="background:lightyellow;" >
    <label for="classid"> CLASS_ID WHOSE CLASS_STRENGTH NEED TO BE CHANGED:</label><br><br>
