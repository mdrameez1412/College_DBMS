...
<h3 style="font-size:150%;font-family:algerian;"><i>ATTENDANCE RECORD</i></h3>
</th></tr>
</table >
...
<table style="border:5px solid black;background:lightyellow;">
  ...
  <th style="border:3px solid black;font-size:large;color:red;">TOTAL NO OF DAYS</th>
  <th style="border:3px solid black;font-size:large;color:red;">NO OF DAYS PRESENT</th>
...
<tr style="border:3px solid black;">
  ...
  <td style="border:3px solid black;font-size:large;"><div align="center"><?php echo $row["TOTAL_NO_OF_DAYS"];?></td></div>
  <td style="border:3px solid black;font-size:large;"><div align="center"><?php echo  $row["NO_OF_DAYS_PRESENT"];?></td></div>
