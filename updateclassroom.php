...
if ( isset($classid) && isset($studentid) ) {
$sql = "UPDATE classroom SET CLASS_ID='$classid' WHERE STUDENT_ID=$studentid";
}
...
<!DOCTYPE html>
<head>
  <title>UPDATING CLASS_ID FOR A STUDENT IN CLASSROOM TABLE</title>
</head>
<body>
  ...
  <h3 style="font-size:150%;font-family:algerian;"><i>UPDATING CLASS_ID FOR A STUDENT IN CLASSROOM TABLE</i></h3><br></th></tr>
</table>
  ...
  <div align="center">
<?php
if ( isset($studentid) && isset($studentfname) ) {

if (mysqli_query($conn, $sql)) {
  echo ('<h2 style="color: green;">'."CLASS_ID UPDATED AS $classid FOR STUDENT_ID $studentid"."</h2>\n");
} else {
 ...
 ?>
  ...
  <tr><th>
   <form method="POST" style="background:lightyellow;" >
    <label for="studentid"> STUDENT_ID WHOSE CLASS_ID NEED TO BE CHANGED:</label><br><br>
    <input type="text" id="studentid" name="studentid"><br><br>
    <label for="classid">NEW CLASS_ID:</label><br><br>
