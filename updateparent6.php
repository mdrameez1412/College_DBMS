...
if(isset($_POST['parentid']) && isset($_POST['parentincome']) ){
...
if ( isset($parentid) && isset($parentincome) ) {
$sql = "UPDATE parent SET PARENT_INCOME='$parentincome' WHERE PARENT_ID=$parentid";
}
...
<!DOCTYPE html>
<head>
  <title>UPDATING PARENT_INCOME IN PARENT TABLE</title>
</head>
<body>
  ...
  <h3 style="font-size:150%;font-family:algerian;"><i>UPDATING PARENT_INCOME IN PARENT TABLE</i></h3><br></th></tr>
</table>
...
if (mysqli_query($conn, $sql)) {
  echo ('<h2 style="color: green;">'."PARENT_INCOME UPDATED AS $parentincome FOR PARENT_ID $parentid"."</h2>\n");
} else {
 ...
 ?>
  ...
  <tr><th>
   <form method="POST" style="background:lightyellow;" >
    <label for="parentid">PARENT_ID WHOSE INCOME NEED TO BE CHANGED:</label><br><br>
    <input type="text" id="parentid" name="parentid"><br><br>
    <label for="parentincome">NEW PARENT_INCOME:</label><br><br>
    <input type="number" id="parentincome" name="parentincome"><br><br>
