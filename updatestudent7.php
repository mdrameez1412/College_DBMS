...
if(isset($_POST['parentid']) && isset($_POST['studentid']) ){
...
if ( isset($parentid) && isset($studentid) ) {
$sql = "UPDATE student SET PARENT_ID='$parentid' WHERE STUDENT_ID=$studentid";
}
...
<!DOCTYPE html>
<head>
  <title>UPDATING PARENT_ID FOR STUDENT IN STUDENT TABLE</title>
</head>
<body>
  ...
  <h3 style="font-size:150%;font-family:algerian;"><i>UPDATING PARENT_ID FOR STUDENT IN STUDENT TABLE</i></h3><br></th></tr>
</table>
  ...
  <div align="center">
<?php
if ( isset($studentid) && isset($parentid) ) {

if (mysqli_query($conn, $sql)) {
  echo ('<h2 style="color: green;">'."PARENT_ID UPDATED AS $parentid FOR STUDENT_ID $studentid"."</h2>\n");
} else {
 ...
 ?>
  ...
  <tr><th>
   <form method="POST" style="background:lightyellow;" >
    <label for="studentid"> STUDENT_ID WHOSE PARENT_ID NEED TO BE CHANGED:</label><br><br>
    <input type="text" id="studentid" name="studentid"><br><br>
    <label for="parentid">NEW PARENT_ID:</label><br><br>
