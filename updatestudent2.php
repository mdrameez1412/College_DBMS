...
if(isset($_POST['studentfname']) && isset($_POST['studentid']) ){
...
if ( isset($studentfname) && isset($studentid) ) {
$sql = "UPDATE student SET STUDENT_F_NAME='$studentfname' WHERE STUDENT_ID=$studentid";
}
...
<!DOCTYPE html>
<head>
  <title>UPDATING STUDENT_FIRST_NAME IN STUDENT TABLE</title>
</head>
<body>
  ...
  <h3 style="font-size:150%;font-family:algerian;"><i>UPDATING STUDENT_FIRST_NAME IN STUDENT TABLE</i></h3><br></th></tr>
</table>
...
if (mysqli_query($conn, $sql)) {
  echo ('<h2 style="color: green;">'."STUDENT_FIRST_NAME UPDATED AS $studentfname FOR STUDENT_ID $studentid"."</h2>\n");
} else {
 ...
 ?>
  ...
  <tr><th>
   <form method="POST" style="background:lightyellow;" >
    <label for="studentid"> STUDENT_ID WHOSE FIRST NAME NEED TO BE CHANGED:</label><br><br>
    <input type="text" id="studentid" name="studentid"><br><br>
    <label for="studentfname">NEW STUDENT_FIRST_NAME:</label><br><br>
