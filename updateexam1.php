...
if(isset($_POST['examid']) && isset($_POST['oldexamid']) ){
$examid=$_POST['examid'];
$oldexamid=$_POST['oldexamid'];
...
if ( isset($examid) && isset($oldexamid) ) {
$sql = "UPDATE exam SET EXAM_ID='$examid' WHERE EXAM_ID=$oldexamid";
}
...
<!DOCTYPE html>
<head>
  <title>UPDATING EXAM_ID IN EXAM TABLE</title>
</head>
<body>
  ...
  <h3 style="font-size:150%;font-family:algerian;"><i>UPDATING EXAM_ID IN EXAM TABLE</i></h3><br></th></tr>
</table>
  <table style="width:100%;">
  <tr style="border:5px solid white;background:#1aff1a"><th style="border:5px solid black;font-size:large;width: 50%;"><a href="updateexam.html">
...
if (mysqli_query($conn, $sql)) {
  echo ('<h2 style="color: green;">'."EXAM_ID UPDATED FROM $oldexamid TO $examid"."</h2>\n");
} else {
 ...
 ?>
  ...
  <tr><th>
   <form method="POST" style="background:lightyellow;" >
    <label for="oldexamid">OLD EXAM_ID THAT NEED TO BE CHANGED:</label><br><br>
    <input type="text" id="oldexamid" name="oldexamid"><br><br>
    <label for="examid">NEW EXAM_ID:</label><br><br>
