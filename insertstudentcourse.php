...
$sql = "INSERT INTO studentcourse (STUDENT_ID,COURSE_ID)
...
<!DOCTYPE html>
<head>
  <title>INSERTING DATA INTO COURSETAKEN TABLE</title>
</head>
<body>
...
if (mysqli_query($conn, $sql)) {
  echo ('<h2 style="color: green;">'."NEW RECORD INSERTED INTO STUDENT COURSE TABLE SUCCESSFULLY"."</h2>\n");
} else {
