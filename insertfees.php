...
if(isset($_POST['studentid']) && isset($_POST['firstterm']) && isset($_POST['secondterm']) && isset($_POST['thirdterm']) ) {
$studentid =$_POST['studentid'];
$firstterm=$_POST['firstterm'];
$secondterm=$_POST['secondterm'];
$thirdterm=$_POST['thirdterm'];
}
// Check connection
if (!$conn) {
  die("Connection failed: " . mysqli_connect_error());
}
if ( isset($studentid) && isset($firstterm) && isset($secondterm) && isset($thirdterm)  ) {
$sql = "INSERT INTO fees (STUDENT_ID,FIRST_TERM,SECOND_TERM,THIRD_TERM)
VALUES ('$studentid','$firstterm','$secondterm','$thirdterm')";
}
...
<!DOCTYPE html>
<head>
  <title>INSERTING DATA INTO FEES TABLE</title>
</head>
<body>
  ...
  <h3 style="font-size:150%;font-family:algerian;"><i>INSERTING DATA INTO FEES TABLE</i></h3><br></th></tr>
</table>
...
if (mysqli_query($conn, $sql)) {
  echo ('<h2 style="color: green;">'."NEW RECORD INSERTED INTO FEES TABLE SUCCESSFULLY"."</h2>\n");
} else {
 ...
 ?>
  ...
  <tr><th>
   <form method="POST" style="background:lightyellow;" >
    ...
    <p><label for="firstterm">FIRST_TERM:<br><br>
 <select name="firstterm" id="firstterm">
   ...
   <option value="pending">PENDING</option>
    ...
    <p><label for="secondterm">SECOND_TERM:<br><br>
 <select name="secondterm" id="secondterm">
   <option value="not available">-- NOT AVAILABLE --</option>
   <option value="paid">PAID</option>
   <option value="pending">PENDING</option>
 </select>
    ...
    <p><label for="thirdterm">THIRD_TERM:<br><br>
 <select name="thirdterm" id="thirdterm">
   <option value="not available">-- NOT AVAILABLE --</option>
   <option value="paid">PAID</option>
   <option value="pending">PENDING</option>
 </select>
