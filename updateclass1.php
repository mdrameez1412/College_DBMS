...
if(isset($_POST['classid']) && isset($_POST['oldclassid']) ){
$classid=$_POST['classid'];
$oldclassid=$_POST['oldclassid'];
...
if ( isset($classid) && isset($oldclassid) ) {
$sql = "UPDATE class SET CLASS_ID='$classid' WHERE CLASS_ID=$oldclassid";
}
...
<!DOCTYPE html>
<head>
  <title>UPDATING CLASS_ID IN CLASS TABLE</title>
</head>
<body>
  ...
  <h3 style="font-size:150%;font-family:algerian;"><i>UPDATING CLASS_ID IN CLASS TABLE</i></h3><br></th></tr>
</table>
...
if (mysqli_query($conn, $sql)) {
  echo ('<h2 style="color: green;">'."CLASS_ID UPDATED FROM $oldclassid TO $classid"."</h2>\n");
} else {
 ...
 ?>
  ...
  <tr><th>
   <form method="POST" style="background:lightyellow;" >
    <label for="oldclassid">OLD CLASS_ID THAT NEED TO BE CHANGED:</label><br><br>
    <input type="text" id="oldclassid" name="oldclassid"><br><br>
