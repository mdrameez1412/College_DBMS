...
if(isset($_POST['studentid']) && isset($_POST['oldstudentid']) ){
...
if ( isset($studentid) && isset($oldstudentid) ) {
$sql = "UPDATE student SET STUDENT_ID='$studentid' WHERE STUDENT_ID=$oldstudentid";
}
...
<!DOCTYPE html>
<head>
  <title>UPDATING STUDENT_ID IN STUDENT TABLE</title>
</head>
<body>
  ...
  <h3 style="font-size:150%;font-family:algerian;"><i>UPDATING STUDENT_ID IN STUDENT TABLE</i></h3><br></th></tr>
</table>
...
if (mysqli_query($conn, $sql)) {
  echo ('<h2 style="color: green;">'."STUDENT_ID UPDATED FROM $oldstudentid TO $studentid"."</h2>\n");
} else {
 ...
 ?>
  ...
  <tr><th>
   <form method="POST" style="background:lightyellow;" >
    <label for="oldstudentid">OLD STUDENT_ID THAT NEED TO BE CHANGED:</label><br><br>
    <input type="text" id="oldstudentid" name="oldstudentid"><br><br>
    <label for="studentid">NEW STUDENT_ID:</label><br><br>
