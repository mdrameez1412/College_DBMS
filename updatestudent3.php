...
if(isset($_POST['studentlname']) && isset($_POST['studentid']) ){
...
if ( isset($studentlname) && isset($studentid) ) {
$sql = "UPDATE student SET STUDENT_L_NAME='$studentlname' WHERE STUDENT_ID=$studentid";
}
...
<!DOCTYPE html>
<head>
  <title>UPDATING  STUDENT_LAST_NAME IN STUDENT TABLE</title>
</head>
<body>
  ...
  <h3 style="font-size:150%;font-family:algerian;"><i>UPDATING STUDENT_LAST_NAME IN STUDENT TABLE</i></h3><br></th></tr>
</table>
  ...
  <div align="center">
<?php
if ( isset($studentid) && isset($studentlname) ) {

if (mysqli_query($conn, $sql)) {
  echo ('<h2 style="color: green;">'."STUDENT_LAST_NAME UPDATED AS $studentlname FOR STUDENT_ID $studentid"."</h2>\n");
} else {
 ...
 ?>
  ...
  <tr><th>
   <form method="POST" style="background:lightyellow;" >
    <label for="studentid">STUDENT_ID WHOSE LAST NAME NEED TO BE CHANGED:</label><br><br>
    <input type="text" id="studentid" name="studentid"><br><br>
    <label for="studentlname">NEW STUDENT_LAST_NAME:</label><br><br>
