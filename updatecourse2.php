...
<!DOCTYPE html>
<head>
  <title>UPDATING COURSE_NAME IN COURSE TABLE</title>
</head>
<body>
  ...
  <h3 style="font-size:150%;font-family:algerian;"><i>UPDATING COURSE_NAME IN COURSE TABLE</i></h3><br></th></tr>
</table>
...
if (mysqli_query($conn, $sql)) {
  echo ('<h2 style="color: green;">'."COURSE_NAME UPDATED AS $coursename FOR COURSE_ID $courseid"."</h2>\n");
} else {
 ...
 ?>
  ...
  <tr><th>
   <form method="POST" style="background:lightyellow;" >
    <label for="courseid">COURSE_ID WHOSE COURSE_NAME NEED TO BE CHANGED:</label><br><br>
    <input type="text" id="courseid" name="courseid"><br><br>
    <label for="coursename">NEW COURSE_NAME:</label><br><br>
