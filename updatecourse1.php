...
if(isset($_POST['courseid']) && isset($_POST['oldcourseid']) ){
...
if ( isset($courseid) && isset($oldcourseid) ) {
$sql = "UPDATE course SET COURSE_ID='$courseid' WHERE COURSE_ID=$oldcourseid";
}
...
<!DOCTYPE html>
<head>
  <title>UPDATING COURSE_ID IN COURSE TABLE</title>
</head>
<body>
  ...
  <h3 style="font-size:150%;font-family:algerian;"><i>UPDATING COURSE_ID IN COURSE TABLE</i></h3><br></th></tr>
</table>
  <table style="width:100%;">
  <tr style="border:5px solid white;background:#1aff1a"><th style="border:5px solid black;font-size:large;width: 50%;"><a href="updatecourse.html">
...
if (mysqli_query($conn, $sql)) {
  echo ('<h2 style="color: green;">'."COURSE_ID UPDATED FROM $oldcourseid TO $courseid"."</h2>\n");
} else {
 ...
 ?>
  ...
  <tr><th>
   <form method="POST" style="background:lightyellow;" >
    <label for="oldcourseid">OLD COURSE_ID THAT NEED TO BE CHANGED:</label><br><br>
    <input type="text" id="oldcourseid" name="oldcourseid"><br><br>
    <label for="courseid">NEW COURSE_ID:</label><br><br>
